...
//     char sensor_adress[] = "/dev/i2c-1";

//     id.dev_addr = BME280_I2C_ADDR_PRIM;

//     if ((id.fd = open(sensor_adress, O_RDWR)) < 0)
//     {
...
float get_temperature_bme() {
    float external_temperature = stream_sensor_data_forced_mode(&dev);
